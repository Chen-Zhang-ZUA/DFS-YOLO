...
class Bottleneck_DMB(Bottleneck):
    ...
    def __init__(self, c1, c2, wm=None, wm_name=None, shortcut=True, g=1, k=(3, 3), e=0.5):  # ch_in, ch_out, shortcut, groups, kernels, expand
        ...
        self.cv1 = DMB(c1, c_, wm, f'{wm_name}_cv1', (k[0], k[0]), 1)
        self.cv2 = DMB(c_, c2, wm, f'{wm_name}_cv2' , (k[1], k[1]), 1, g=g)
...
class C3k_DMB(C3k):
    def __init__(self, c1, c2, n=1, wm=None, wm_name=None, shortcut=False, g=1, e=0.5, k=3):
        ...
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(Bottleneck_DMB(c_, c_, wm, wm_name, shortcut, g, k=(k, k), e=1.0) for _ in range(n)))

class C3k2_DMB(C3k2):
    def __init__(self, c1, c2, n=1, wm=None, wm_name=None, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(C3k_DMB(self.c, self.c, 2, wm, wm_name, shortcut, g) if c3k else Bottleneck_DMB(self.c, self.c, wm, wm_name) for _ in range(n))
